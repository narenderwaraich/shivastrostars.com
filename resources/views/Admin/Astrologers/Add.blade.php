  ...
  <section class="content-wrapper" style="min-height: 960px;">
    <section class="content-header">
      ...
      <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form action="/join-astrologer" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <div class="box">
                     ...
                     <div class="col-md-12">
                        ...
                        <img src="/public/images/user/" id="profile-img-tag" class="show-product-img">
                          <input type="file" name="avatar" id="getFile" accept="/image/*" style="visibility: hidden;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors->has('phone_no') ? ' is-invalid' : '' }}" name="phone_no" placeholder="Enter Phone Number" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control {{ $errors->has('date') ? ' is-invalid' : '' }}" name="date" placeholder="Enter Date of Birth" required>
                                @if ($errors->has('date'))
                                <span class="invalid-feedback" role="alert">
                            ...
                            @endforeach
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea name="address" id="proDesc"  rows="5" placeholder="Address" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" maxlength="150" minlength="5" required onkeyup="countChar(this)"></textarea>
                                  </div>
