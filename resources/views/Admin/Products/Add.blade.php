            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <img src="" id="showUpLog" class="show-product-img profile-img-tag" style="display: none;">
                <div class="form-group">
                  <label for="title">Category</label>
                  <select id="categoryId" class="form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}" name="category_id" required>
                ...
                <p style="color: #ce2350;font-weight: 600;display: none;" id="per_ratti_show">Enter Per Ratti Product Amount</p>
                <div class="form-group">
                  <label for="title">Original Price</label>
                  <input type="number" class="form-control{{ $errors->has('original_price') ? ' is-invalid' : '' }}" name="original_price" placeholder="Enter Original Price" value="{{ old('original_price') }}" min="1" max="10000" required>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" placeholder="Enter Sale Price" value="{{ old('price') }}" min="1" max="10000" required>
                  @if ($errors->has('price'))
                  <span class="invalid-feedback" role="alert">
